 ...
 */
#define INTNO_IPI_PRC1 ((1 << 16) | (RP2040_SIO_PROC0_IRQn + 16))
#define INTNO_IPI_PRC2 ((2 << 16) | (RP2040_SIO_PROC1_IRQn + 16))

#define INHNO_IPI_PRC1 ((1 << 16) | (RP2040_SIO_PROC0_IRQn + 16))
#define INHNO_IPI_PRC2 ((2 << 16) | (RP2040_SIO_PROC1_IRQn + 16))
...
{
    sil_wrw_mem(RP2040_SIO_FIFO_WR, IPINO_DISPATCH);
}
...
{
    sil_wrw_mem(RP2040_SIO_FIFO_WR, IPINO_EXT_KER);
}
...
{
    sil_wrw_mem(RP2040_SIO_FIFO_WR, IPINO_SET_HRT_EVT);
}
